...
<p style="color:#0000CD; font-size: 24px;"> Ch Student Password Recovery:</font>
...
<form action="erpchforgetpassw" method="post">
(put the email id in textfield(sample@gmail.com)) 
<input type="text" name="email" style="width:300px; height:30px;">
