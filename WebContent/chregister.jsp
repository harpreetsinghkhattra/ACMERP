...
<p style="color:#0000FF; font-size:24px">Registeration Of Chairman:</p>
</div>
<div style="padding-left: 220px;">
<p style="color:#FF4500"><font size="6px">${message35}</font></p>    
             <c:remove var="message35" scope="session"/>
<form action="erpchregisterr" method="post" >
...
<div id="t" style="display:none;"><button type="submit" name="register_attendent" class="bo">Register</button></div></td>
<td>
<button type="submit" name="cancel" class="bo" >cancel</button></td></tr>
</table>
</div>
</form>
</div>
